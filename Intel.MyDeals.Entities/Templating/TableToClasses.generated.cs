...
Modified: 10/01/2018 2:13:22 PM
...
namespace Intel.MyDeals.Entities {
	...
	*/
	...
	[DataMember]
	public System.Int32 EMAIL_NN {set;get;}
	
	
	[DataMember]
	public System.Int32 IN_TOOL_NN {set;get;}
	...
	int IDX_EMAIL_NN = DB.GetReaderOrdinal(rdr, "EMAIL_NN");
	int IDX_IN_TOOL_NN = DB.GetReaderOrdinal(rdr, "IN_TOOL_NN");
	...
	EMAIL_NN = (IDX_EMAIL_NN < 0 || rdr.IsDBNull(IDX_EMAIL_NN)) ? default(System.Int32) : rdr.GetFieldValue<System.Int32>(IDX_EMAIL_NN),
	IN_TOOL_NN = (IDX_IN_TOOL_NN < 0 || rdr.IsDBNull(IDX_IN_TOOL_NN)) ? default(System.Int32) : rdr.GetFieldValue<System.Int32>(IDX_IN_TOOL_NN),
