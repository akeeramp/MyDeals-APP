...
Modified: 11/29/2016 9:29:57 AM
...
namespace Intel.MyDeals.Entities {
	...
	*/
	...
	[DataContract]
	public partial class MyCustomersLineupAttributes {
	...
	[DataMember]
	public System.Int32 DA_EMAIL_LIST {set;get;}
	
	
	[DataMember]
	public System.Int32 DIV_APRV_FLG {set;get;}
	
	
	[DataMember]
	public System.Int32 GA_EMAIL_LIST {set;get;}
	
	
	[DataMember]
	public System.Int32 LAR_CUST_FLG {set;get;}
	
	
	[DataMember]
	public System.Int32 ODM_CUST_FLG {set;get;}
	
	
	[DataMember]
	public System.Int32 TIER_LVL {set;get;}
	
	
	/*
	private static List<MyCustomersLineupAttributes> MyCustomersLineupAttributesFromReader(SqlDataReader rdr){
	// This helper method is template generated.
	// Refer to that template for details to modify this code.
	
	var ret = new List<MyCustomersLineupAttributes>();
	int IDX_CUST_DIV_NM = DB.GetReaderOrdinal(rdr, "CUST_DIV_NM");
	int IDX_CUST_MBR_SID = DB.GetReaderOrdinal(rdr, "CUST_MBR_SID");
	...
	while (rdr.Read()){
	ret.Add(new MyCustomersLineupAttributes {
	CUST_DIV_NM = (IDX_CUST_DIV_NM < 0 || rdr.IsDBNull(IDX_CUST_DIV_NM)) ? String.Empty : rdr.GetFieldValue<System.String>(IDX_CUST_DIV_NM),
	CUST_MBR_SID = (IDX_CUST_MBR_SID < 0 || rdr.IsDBNull(IDX_CUST_MBR_SID)) ? default(System.Int32) : rdr.GetFieldValue<System.Int32>(IDX_CUST_MBR_SID),
	...
	*/
	...
	} // End of class MyCustomersLineupAttributes
