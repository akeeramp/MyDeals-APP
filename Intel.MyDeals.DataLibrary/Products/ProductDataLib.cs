...
using Intel.MyDeals.Entities.Custom;
...
namespace Intel.MyDeals.DataLibrary
{
    public class ProductDataLib : IProductDataLib
    {
        ...
        public ProductDetails GetProducts(SearchParams objSearchParams = null)
        {
            ...
            {
                objSearchParams = new SearchParams
                {
                    Take = -1,
                    Skip = 0,
                    StrFilters = String.Empty,
                    StrSorts = String.Empty,
                    FtchCnt = false
                };
            }
        ...
        /// <summary>
        /// This method will be responsible for Exclude and Filter
        /// </summary>
        ...
        /// <summary>
        /// Get product translation results
        /// </summary>
        ...
        /// <summary>
        /// Get Products with include and exclude filters
        /// </summary>
        /// <param name="productsToMatch"></param>
        /// <param name="CUST_MBR_SID"></param>
        /// <returns></returns>
        ...
        public ProductSelectorWrapper GetProductSelectorWrapper()
        {
            ...
            try
            {
                using (var rdr = DataAccess.ExecuteReader(cmd))
                {
                    ...
                    int IDX_BOX_END_DT1 = DB.GetReaderOrdinal(rdr, "BOX_END_DT");
                    int IDX_BOX_STRD_DT1 = DB.GetReaderOrdinal(rdr, "BOX_STRD_DT");
                    int IDX_GDM_BRND_NM = DB.GetReaderOrdinal(rdr, "GDM_BRND_NM");
                    int IDX_GDM_FMLY_NM = DB.GetReaderOrdinal(rdr, "GDM_FMLY_NM");
                    ...
                    int IDX_TRAY_END_DT1 = DB.GetReaderOrdinal(rdr, "TRAY_END_DT");
                    int IDX_TRAY_STRT_DT1 = DB.GetReaderOrdinal(rdr, "TRAY_STRT_DT");

                    while (rdr.Read())
                    {
                        ret.ProductSelectionLevelsAttributes.Add(new ProductSelectionLevelsAttributes
                        {
                            BOX_END_DT = (IDX_BOX_END_DT1 < 0 || rdr.IsDBNull(IDX_BOX_END_DT1)) ? default(System.DateTime) : rdr.GetFieldValue<System.DateTime>(IDX_BOX_END_DT1),
                            BOX_STRD_DT = (IDX_BOX_STRD_DT1 < 0 || rdr.IsDBNull(IDX_BOX_STRD_DT1)) ? default(System.DateTime) : rdr.GetFieldValue<System.DateTime>(IDX_BOX_STRD_DT1),
                            GDM_BRND_NM = (IDX_GDM_BRND_NM < 0 || rdr.IsDBNull(IDX_GDM_BRND_NM)) ? String.Empty : rdr.GetFieldValue<System.String>(IDX_GDM_BRND_NM),
                            GDM_FMLY_NM = (IDX_GDM_FMLY_NM < 0 || rdr.IsDBNull(IDX_GDM_FMLY_NM)) ? String.Empty : rdr.GetFieldValue<System.String>(IDX_GDM_FMLY_NM),
                            ...
                            TRAY_END_DT = (IDX_TRAY_END_DT1 < 0 || rdr.IsDBNull(IDX_TRAY_END_DT1)) ? default(System.DateTime) : rdr.GetFieldValue<System.DateTime>(IDX_TRAY_END_DT1),
                            TRAY_STRT_DT = (IDX_TRAY_STRT_DT1 < 0 || rdr.IsDBNull(IDX_TRAY_STRT_DT1)) ? default(System.DateTime) : rdr.GetFieldValue<System.DateTime>(IDX_TRAY_STRT_DT1)
                        });
                    } // while
                }
            }
                ...
                int selectionLevel, string drillDownFilter4, string drillDownFilter5, int custSid, string geoSid, string mediaCd, OpDataElementSetType dealType)
        {
            ...
            try
            {
                ...
                {
                    cmd.DRILL_DOWN_FLTR_4 = drillDownFilter4;
                }
                if (drillDownFilter5 != null)
                {
                    cmd.DRILL_DOWN_FLTR_5 = drillDownFilter5;
                }
                using (var rdr = DataAccess.ExecuteReader(cmd))
                {
                    int IDX_BRND_NM = DB.GetReaderOrdinal(rdr, "BRND_NM");
        ...
        /// <summary>
        /// Get deal products from Product details with CAP
        /// </summary>
        ...
        public List<DealProducts> GetDealProducts(int objSid, OpDataElementType objTypeSid, int custId, bool isMissingFlag)
        {
            ...
            try
            {
                var cmd = new Procs.dbo.PR_MYDL_GET_DEAL_GRP_PRD
                {
                    IN_OBJ_TYPE_SID = (int)objTypeSid,
                    IN_OBJ_SID = objSid,
                    IN_CUST_MBR_SID = custId,
                    IN_MISSING_FLG = isMissingFlag
                };
        ...
        public List<FlexProdOvlp> GetProductOVLPValidation(ProductOVLPValidation objProductOVLPValidation)
        {
            ...
            try
            {
                using (var rdr = DataAccess.ExecuteReader(cmd))
                {
                    ...
                    int IDX_OVLP_ROW_ID = DB.GetReaderOrdinal(rdr, "OVLP_ROW_ID");
                    int IDX_PRD_MBR_SID = DB.GetReaderOrdinal(rdr, "PRD_MBR_SID");
                    ...
                    while (rdr.Read())
                    {
                        ret.Add(new FlexProdOvlp
                        {
                            ...
                            OVLP_ROW_ID = (IDX_OVLP_ROW_ID < 0 || rdr.IsDBNull(IDX_OVLP_ROW_ID)) ? String.Empty : rdr.GetFieldValue<System.String>(IDX_OVLP_ROW_ID),
                            PRD_MBR_SID = (IDX_PRD_MBR_SID < 0 || rdr.IsDBNull(IDX_PRD_MBR_SID)) ? default(System.Int32) : rdr.GetFieldValue<System.Int32>(IDX_PRD_MBR_SID),
        ...
        {
            OpLog.Log("GetProductSelectorDtl");
            var ret = new List<ProductSelectionResults>();
            try
            { 
                var cmd = new Procs.dbo.PR_MYDL_GET_PRD_SELECTOR_DTL
                {
                    CUST_ID = objFilterProductSelector.CUST_ID,
                    FMLY_NM = objFilterProductSelector.FMLY_NM,
                    PRD_ATRB_SID = objFilterProductSelector.PRD_ATRB_SID,
                    USER_SEARCH = objFilterProductSelector.USER_SEARCH
                }; 
                using (var rdr = DataAccess.ExecuteReader(cmd))
                {
                    int IDX_BRND_NM = DB.GetReaderOrdinal(rdr, "BRND_NM");
