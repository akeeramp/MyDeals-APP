    ...
    internal class UiTemplateDataLib : IUiTemplateDataLib
    {
        private List<UiTemplateContainerItem> GetData()
        {
            ...
            items.Add(new UiTemplateContainerItem
            {
                ...
                ObjSetType = new List<OpDataElementSetType> { OpDataElementSetType.ECAP },
                Width = 130,
                Template = "#=gridUtils.uiDimControlWrapper(data, 'ECAP_PRICE', '7___1____20___0', 'currency')#",
                DataType = "object",
                IsFilterable = true,
                IsSortable = true,
                Format = "{0:c}"
            ...
            items.Add(new UiTemplateContainerItem
            {
                ...
                ObjType = new List<OpDataElementType> { OpDataElementType.WIP_DEAL },
                Width = 130,
                Template = "<op-popover ng-click='openCAPBreakOut(dataItem, \"CAP\")' op-options='CAP' op-label='' op-data='getPrductDetails(dataItem, \"CAP\")'>#=gridUtils.uiMoneyDatesControlWrapper(data, 'CAP', 'CAP_STRT_DT', 'CAP_END_DT', '7___1____20___0')#</op-popover>",
                Label = "CAP Info",
                DataType = "object",
                IsFilterable = true,
                IsSortable = true,
            ...
            items.Add(new UiTemplateContainerItem
            {
                ...
                ObjType = new List<OpDataElementType> { OpDataElementType.WIP_DEAL },
                Width = 130,
                Template = "#=gridUtils.uiDimControlWrapper(data, 'CAP', '7___1____20___0', 'currency')#",
                DataType = "object",
                IsFilterable = true,
                IsSortable = true,
                Format = "{0:c}"
            ...
            items.Add(new UiTemplateContainerItem
            {
                ...
                ObjType = new List<OpDataElementType> { OpDataElementType.WIP_DEAL },
                Template = "#=gridUtils.uiDimControlWrapper(data, 'CAP_STRT_DT', '7___1____20___0', \"date:'MM/dd/yyyy'\")#",
                DataType = "object",
                IsFilterable = true,
                IsSortable = true,
                IsHidden = true,
            ...
            items.Add(new UiTemplateContainerItem
            {
                ...
                ObjType = new List<OpDataElementType> { OpDataElementType.WIP_DEAL },
                Template = "#=gridUtils.uiDimControlWrapper(data, 'CAP_END_DT', '7___1____20___0', \"date:'MM/dd/yyyy'\")#",
                DataType = "object",
                IsFilterable = true,
                IsSortable = true,
                IsHidden = true,
            ...
            items.Add(new UiTemplateContainerItem
            {
                ...
                IsSortable = true,
                IsReadOnly = true,
                Template = "<op-popover op-options='YCS2' op-data='getPrductDetails(dataItem, \"YCS2\")'>#=gridUtils.uiMoneyDatesControlWrapper(data, 'YCS2_PRC_IRBT', 'YCS2_START_DT', 'YCS2_END_DT', '7___1____20___0')#</op-popover>",
            });
            items.Add(new UiTemplateContainerItem
            {
                Id = 29,
                ...
                ObjType = new List<OpDataElementType> { OpDataElementType.WIP_DEAL },
                Width = 130,
                Template = "#=gridUtils.uiDimControlWrapper(data, 'YCS2_PRC_IRBT', '7___1____20___0', 'currency')#",
                Label = "YCS2 Price",
                DataType = "object",
                IsFilterable = true,
                IsSortable = true,
            ...
            items.Add(new UiTemplateContainerItem
            {
                ...
                ObjType = new List<OpDataElementType> { OpDataElementType.WIP_DEAL },
                Template = "#=gridUtils.uiDimControlWrapper(data, 'YCS2_START_DT', '7___1____20___0', \"date:'MM/dd/yyyy'\")#",
                DataType = "object",
                IsFilterable = true,
                IsSortable = true,
                IsHidden = true,
            ...
            items.Add(new UiTemplateContainerItem
            {
                ...
                ObjType = new List<OpDataElementType> { OpDataElementType.WIP_DEAL },
                Template = "#=gridUtils.uiDimControlWrapper(data, 'YCS2_END_DT', '7___1____20___0', \"date:'MM/dd/yyyy'\")#",
                DataType = "object",
                IsFilterable = true,
                IsSortable = true,
                IsHidden = true,
