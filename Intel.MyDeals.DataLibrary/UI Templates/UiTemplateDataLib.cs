...
namespace Intel.MyDeals.DataLibrary
{
    class UiTemplateDataLib : IUiTemplateDataLib
    {
        ...
        private List<UiTemplateContainerItem> GetData()
        {
            ...
            items.Add(new UiTemplateContainerItem { Id = 3, AtrbCd = AttributeCodes.TITLE, ObjType = new List<OpDataElementType> { OpDataElementType.PricingTableRow }, DataType = "string", Label = "Title", Width = 150 });
            ...
            items.Add(new UiTemplateContainerItem { Id = 20, AtrbCd = AttributeCodes.DC_ID, IsKey = true, ObjType = new List<OpDataElementType> { OpDataElementType.WipDeals }, IsDetail = true, DataType = "number", Label = "Id", Width = 50 });
            ...
            items.Add(new UiTemplateContainerItem { Id = 22, AtrbCd = AttributeCodes.TITLE, ObjType = new List<OpDataElementType> { OpDataElementType.WipDeals }, IsDetail = true, DataType = "string", Label = "Title", Width = 150 });
