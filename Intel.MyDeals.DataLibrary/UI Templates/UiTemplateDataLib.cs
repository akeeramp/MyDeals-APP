...
namespace Intel.MyDeals.DataLibrary
{
    class UiTemplateDataLib : IUiTemplateDataLib
    {
        ...
        private List<UiTemplateContainerItem> GetData()
        {
            ...
            items.Add(new UiTemplateContainerItem { Id = 7, AtrbCd = "ECAP", ObjSetType = new List<OpDataElementSetType> { OpDataElementSetType.ECAP }, DataType = "string", Label = "Ecap", Width = 150 });
            items.Add(new UiTemplateContainerItem { Id = 8, AtrbCd = "PROGRAM", ObjSetType = new List<OpDataElementSetType> { OpDataElementSetType.PROGRAM }, DataType = "string", Label = "Program", Width = 150 });
            items.Add(new UiTemplateContainerItem { Id = 9, AtrbCd = "VOLTIER", ObjSetType = new List<OpDataElementSetType> { OpDataElementSetType.VOL_TIER }, DataType = "string", Label = "Vol Tier", Width = 150 });
            items.Add(new UiTemplateContainerItem { Id = 10, AtrbCd = "CAPBAND", ObjSetType = new List<OpDataElementSetType> { OpDataElementSetType.CAP_BAND }, DataType = "string", Label = "Cap Band", Width = 150 });
