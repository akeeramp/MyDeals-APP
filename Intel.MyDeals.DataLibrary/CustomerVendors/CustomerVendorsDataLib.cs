...
namespace Intel.MyDeals.DataLibrary
{
    public class CustomerVendorsDataLib : ICustomerVendorsDataLib
    {
        ...
        public List<CustomerVendors> GetCustomerVendors(int custId = 0)
        {
            ...
            var cmd = new Procs.dbo.PR_MYDL_GET_VNDR_CUST_MAP
            {
            ...
            try
            {
                using (var rdr = DataAccess.ExecuteReader(cmd))
                {
                    ...
                    int IDX_SUPL_ID = DB.GetReaderOrdinal(rdr, "SUPL_ID");
                    int IDX_SUPL_NM = DB.GetReaderOrdinal(rdr, "SUPL_NM");
                    ...
                    while (rdr.Read())
                    {
                        ret.Add(new CustomerVendors
                        {
                            ...
                            SUPL_ID = (IDX_SUPL_ID < 0 || rdr.IsDBNull(IDX_SUPL_ID)) ? default(System.Int32) : rdr.GetFieldValue<System.Int32>(IDX_SUPL_ID),
                            SUPL_NM = (IDX_SUPL_NM < 0 || rdr.IsDBNull(IDX_SUPL_NM)) ? String.Empty : rdr.GetFieldValue<System.String>(IDX_SUPL_NM),
        ...
        public CustomerVendors ManageCustomerVendors(CustomerVendors CustVendor, CrudModes type)
        {
            ...
            data.ATRB_LKUP_DESC = CustVendor.SUPL_ID.ToString();
