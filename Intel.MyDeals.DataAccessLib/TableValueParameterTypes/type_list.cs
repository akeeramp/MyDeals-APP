...
{
    public class type_list : SqlTableValueParameterBase
    {
        private const string DATA_TABLE_NAME = "dbo.type_list";


        public type_list(params string[] itms)
            : base(DATA_TABLE_NAME)
        {
            AddRows(itms);
        }

        public type_list(SerializationInfo info, StreamingContext context)
        ...
        /// </summary>
        public void AddRows(params string[] itms)
        {
            if (itms == null) { return; }
        ...
        /// Add a rows to the table parameter
        /// </summary>
        public void AddRows(IEnumerable<string> itms)
        {
            if (itms == null) { return; }
