...
namespace Intel.MyDeals.DataLibrary.Test
{
	...
	public class SecurityAttributesDataLibTests
	{
		...
		public void AdminSecurityActionsManage()
		{
            ...
            //DELETE
            bool deleteResult = new SecurityAttributesDataLib().DeleteSecurityAction(updateResult.ACTN_SID);
        ...
        public void AdminDealTypesManage()
        {
            ...
            //DELETE
            bool deleteResult = new SecurityAttributesDataLib().DeleteAdminDealType(updateResult.DEAL_TYPE_SID);
            Assert.IsTrue(deleteResult);
        }
        ...
        public void AdminRoleTypesManage()
        {
            ...
            //DELETE
            bool deleteResult = new SecurityAttributesDataLib().DeleteAdminRoleType(updateResult.ROLE_TYPE_SID);
            Assert.IsTrue(deleteResult);
        }
