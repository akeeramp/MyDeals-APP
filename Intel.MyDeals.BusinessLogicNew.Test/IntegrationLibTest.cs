...
namespace Intel.MyDeals.BusinessLogicNew.Test
{
    ...
    public class IntegrationLibTest
    {
        ...
        public Mock<IEmployeesLib> mockEmployee = new Mock<IEmployeesLib>();
        ...
        {
            var res = new IntegrationLib(mockJmsDataLib.Object,mockDataCollectorLib.Object,mockPrimeCustomerLib.Object, mockConstantsLookupsLib.Object,mockDataFixDataLib.Object, mockEmployee.Object).ReTriggerMuleSoftByXid(xid);
        ...
        public void IqrFetchCapData_ReturnsErrorCustomerMappingIdString_forEmptyCustomerCustomerMappingIdInput_orZeroCustId(dynamic data)
        {
            ...
            if (TenderCapRequestObject_input.CustomerMappingId == "")
            {
                ...
                res = new IntegrationLib(mockJmsDataLib.Object, mockDataCollectorLib.Object, mockPrimeCustomerLib.Object, mockConstantsLookupsLib.Object, mockDataFixDataLib.Object, mockEmployee.Object).IqrFetchCapData(TenderCapRequestObject_input);
            }
            else
            {
        ...
        public void IqrFetchCapData_ReturnsErrorEmpIdLookupString_forEmptyMydlPdctName_orZeroPdctNbrSid(string type)
        {
            ...
            var res = new IntegrationLib(mockJmsDataLib.Object, mockDataCollectorLib.Object, mockPrimeCustomerLib.Object, mockConstantsLookupsLib.Object, mockDataFixDataLib.Object, mockEmployee.Object).IqrFetchCapData(TenderCapRequestObject_input);
        ...
        public void IqrFetchCapData_ThrowsException_forInvalidStartOrEndDate(dynamic data)
        {
            ...
            {
                Assert.Throws<ArgumentNullException>(() => new IntegrationLib(mockJmsDataLib.Object, mockDataCollectorLib.Object, mockPrimeCustomerLib.Object, mockConstantsLookupsLib.Object, mockDataFixDataLib.Object, mockEmployee.Object).IqrFetchCapData(TenderCapRequestObject_input));
            }else if(TenderCapRequestObject_input.RangeStartDate == "" || TenderCapRequestObject_input.RangeEndDate == "")
            {
                Assert.Throws<FormatException>(() => new IntegrationLib(mockJmsDataLib.Object, mockDataCollectorLib.Object, mockPrimeCustomerLib.Object, mockConstantsLookupsLib.Object, mockDataFixDataLib.Object, mockEmployee.Object).IqrFetchCapData(TenderCapRequestObject_input));
            }
        }
        ...
        public void ReturnSalesForceTenderResults_ReturnsStringContainingSuccessfullyReturned()
        {
            ...
            var res = new IntegrationLib(mockJmsDataLib.Object, mockDataCollectorLib.Object, mockPrimeCustomerLib.Object, mockConstantsLookupsLib.Object, mockDataFixDataLib.Object, mockEmployee.Object).ReturnSalesForceTenderResults();
        ...
        public void MuleSoftReturnTenderStatus_ReturnsAppropriateStringBasedOnRetstatus(string xid, string retStatus)
        {
            ...
            {
                var res = new IntegrationLib(mockJmsDataLib.Object, mockDataCollectorLib.Object, mockPrimeCustomerLib.Object, mockConstantsLookupsLib.Object, mockDataFixDataLib.Object, mockEmployee.Object).MuleSoftReturnTenderStatus(xid, retStatus);
                Assert.That(res.Contains($"{xid}"));
            }
            else
            {
        ...
        {   
            ...
            var res = new IntegrationLib(mockJmsDataLib.Object, mockDataCollectorLib.Object, mockPrimeCustomerLib.Object, mockConstantsLookupsLib.Object, mockDataFixDataLib.Object, mockEmployee.Object).MuleSoftReturnTenderStatusByGuid(btchId,retStatus,dealId );
            mockJmsDataLib.Verify();
        ...
        public void UpdateUnifiedEndCustomer_callsVoidMethodsProperly(int CntrctId, string saleForceId, string primeCustomerName, string primeCustomerCountry)
        {
            ...
            mockJmsDataLib.Setup(x => x.PublishBackToSfTenders(It.IsAny<string>())).Returns(true);
            mockJmsDataLib.Setup(x => x.UpdateTendersStage(It.IsAny<Guid>(), It.Is<string>(r=> r == "PO_Processing_Complete"), It.IsAny<List<int>>())).Verifiable();
            new IntegrationLib(mockJmsDataLib.Object, mockDataCollectorLib.Object, mockPrimeCustomerLib.Object, mockConstantsLookupsLib.Object, mockDataFixDataLib.Object, mockEmployee.Object).UpdateUnifiedEndCustomer(CntrctId,saleForceId,primeCustomerName,primeCustomerCountry);
            mockJmsDataLib.Verify();
        }
