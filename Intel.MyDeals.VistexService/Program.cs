...
namespace Intel.MyDeals.VistexService
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                VistexProductVerticalOutBound lstTemp = vistexAdminDataLib.GetProductVerticalBody(210);
                VistexProductVerticalOutBound lstTemp1 = vistexAdminDataLib.GetProductVerticalBody(212);
            }
            //int iAttempts = 1;            
            ...
            //    using (VistexAdminDataLib vistexAdminDataLib = new VistexAdminDataLib())
            //    {
            //        var transIds = vistexAdminDataLib.GetVistexDealOutBoundData().Select(x => x.TransanctionId).Distinct();
            //        if (transIds.Count() > 0)
