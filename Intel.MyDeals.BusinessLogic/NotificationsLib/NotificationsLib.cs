...
namespace Intel.MyDeals.BusinessLogic
{
    public class NotificationsLib : INotificationsLib
    {
        ...
        /// <summary>
        /// Get email body for single notification Angular
        /// </summary>
        /// <param name="nltId"></param>
        /// <returns></returns>
        public string GetEmailBodyTemplateUIAngular(int nltId)
        {
            var ids = new List<int>();
            ids.Add(nltId);
            var notifications = GetNotificationEmails(ids);
            return GetEmailBodyTableAngular(notifications.FirstOrDefault(), notifications);
        }

        /// <summary>
        /// Email template changes Angular
        /// </summary>
        /// <param name="notification"></param>
        /// <param name="email"></param>
        /// <returns></returns>
        public string GetEmailBodyTableAngular(NotificationEmailTable notification, List<NotificationEmailTable> email)
        {
            var emailTable = string.Empty;
            var model = email.Where(x => x.NOTIFD_EMP_ADDR == notification.NOTIFD_EMP_ADDR
            && x.NOTIF_ID == notification.NOTIF_ID && notification.CHG_EMAIL_ADDR == notification.CHG_EMAIL_ADDR).ToList();
            ...
            switch (notificationEvent)
            {
                case NotificationEvents.SubmittedToApproved:
                case NotificationEvents.PSInPendingStage:
                    emailTable = GetContractAndPSTableAngular(model);
                    break;

                case NotificationEvents.CapUpdateToDeal:
                case NotificationEvents.CostUpdateToDeal:
                    var extendedProp = NotifExtendedPropXMLDeserialize(model);
                    emailTable = GetDealAndPSTableForCAPandCostAngular(extendedProp);
                    break;

                case NotificationEvents.DealModifiedByOtherUser:
                    emailTable = GetDealAndPSTableAngular(model);
                    break;

                case NotificationEvents.ContractPendingStage:
                    emailTable = GetContractTableAngular(model);
                    break;

                case NotificationEvents.TenderSubmittedToOffer:
                    emailTable = GetContractAndDealTableTenderAngular(model);
                    break;
        ...
        /// <summary>
        /// GetContractAndPSTableAngular
        /// </summary>
        /// <param name="email"></param>
        /// <returns></returns>
        public string GetContractAndPSTableAngular(List<NotificationEmailTable> email)
        {
            var url = MyDealsWebApiUrl.ROOT_URL;
            var template = "@{ var rootUrl =\"" + url + "\";}";
        ...
        /// <summary>
        /// Get Contract And PSTable Tender Angular
        /// </summary>
        /// <param name="email"></param>
        /// <returns></returns>
        public string GetContractAndDealTableTenderAngular(List<NotificationEmailTable> email)
        {
            var url = MyDealsWebApiUrl.ROOT_URL;
            var template = "@{ var rootUrl =\"" + url + "\";}";
        ...
        /// <param name="email"></param>
        /// <returns></returns>
        public string GetDealAndPSTableAngular(List<NotificationEmailTable> email)
        {
            var url = MyDealsWebApiUrl.ROOT_URL;
            var template = "@{ var rootUrl =\"" + url + "\";}";
        ...
        /// <param name="email"></param>
        /// <returns></returns>
        public string GetDealAndPSTableForCAPandCostAngular(List<NotificationMaster> email)
        {
            var url = MyDealsWebApiUrl.ROOT_URL;
            var template = "@{ var rootUrl =\"" + url + "\";}";
        ...
        /// <summary>
        /// Get contract table Angular
        /// </summary>
        /// <param name="email"></param>
        /// <returns></returns>
        public string GetContractTableAngular(List<NotificationEmailTable> email)
        {
            var url = MyDealsWebApiUrl.ROOT_URL;
            var template = "@{ var rootUrl =\"" + url + "\";}";
