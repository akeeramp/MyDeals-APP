(function () {
    ...
    angular
        .module('app.core')
        .directive('advancedSearchResults', advancedSearchResults);

    advancedSearchResults.$inject = ['$compile', 'dataService'];
    function advancedSearchResults($compile, dataService) {
        return {
            restrict: 'E',
            scope: {
                custId: '@',
