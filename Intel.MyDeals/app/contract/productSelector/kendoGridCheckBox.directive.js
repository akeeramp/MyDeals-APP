(function () {
    ...
    function kendoGridCheckBox($filter) {
        ...
        function linkFunc(scope, element, attrs) {
            ...
            if (scope.vm.dealType == 'VOL_TIER' || scope.vm.dealType == 'FLEX' || scope.vm.dealType == 'PROGRAM' || scope.vm.dealType == 'REV_TIER' || scope.vm.dealType == 'DENSITY' || scope.checkboxIsGeneric) {
