(function () {
    ...
    angular
        .module('app.admin')
        .factory('productAliasService', productAliasService);

    // Minification safe dependency injection
    productAliasService.$inject = ['$http', 'dataService', 'logger', '$q'];

    function productAliasService($http, dataService, logger, $q) {
