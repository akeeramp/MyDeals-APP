(function () {
    ...
    angular
        .module('app.admin')
        .controller('ProductAliasController', ProductAliasController)

    ProductAliasController.$inject = ['productAliasService', '$scope', 'logger', 'confirmationModal', 'gridConstants', '$linq']
