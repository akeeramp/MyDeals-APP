(function () {
    ...
    function securityEngineController($scope, logger, SecurityEngineService, lookupsService, confirmationModal, gridConstants, SecUtil, $filter, $q) {
        ...
        var bestGuessAttributes = ["BACK_DATE_RSN", "BLLG_DT", "BOM_SYSTEM_CONFIG", "CA_DATA_CA_ID", "CAP", "COMMENT_HISTORY", "COMP_PRICE_CPU", "COMP_PRICE_CS", "COMP_PRODUCT_CPU_OTHER", "COMP_PRODUCT_CS_OTHER", "COMPETITIVE_NAME", "COMPETITIVE_PRODUCT", "COMPETITIVE_PRODUCT_CPU", "COMPETITIVE_PRODUCT_CS", "DEAL_CORP_ACCNT_DIV", "COST_TEST_OVERRIDE", "COST_TEST_RESULT", "CPU_SPLIT", "CREDIT_AMT", "CREDIT_VOLUME", "CS_SHIP_AHEAD_DT", "CS_SHIP_AHEAD_END_DT", "CS_SHIP_AHEAD_STRT_DT", "CS_SPLIT", "CUST_MBR_SID", "DEAL_CORP_ACCNT_DIV", "DEAL_CUST_DIV_NM", "DEAL_DESC", "DEAL_MSP_PRC", "DEAL_NBR", "DEAL_PGM_TYPE", "DEAL_PRC_CONFLICT", "DEAL_SOLD_TO_ID", "WF_STG_CD", "OBJ_SET_TYPE_CD", "DEBIT_AMT", "DEBIT_VOLUME", "DIVISION_APPROVAL_PRICE", "ECAP_PRICE", "REBATE_TYPE", "END_CAP", "END_CUSTOMER_RETAIL", "END_DT", "END_VOL", "EXPIRE_YCS", "IDMS_SHEET_COMMENT", "LAST_MOD_BY", "LAST_MOD_DT", "LEGAL_COMMENTS", "LINE_NBR", "MARKET_SEGMENT", "MEETCOMP_TEST_RESULT", "MRKT_SEG", "NUM_OF_TIERS", "ON_ADD_DT", "ORIG_ECAP_TRKR_NBR", "PAYOUT_BASED_ON", "PERIOD_PROFILE", "FLEX_ROW_TYPE", "RESET_VOLS_ON_PERIOD", "SYS_PRICE_POINT", "CONSUMPTION_SYS_CONFIG", "SEND_TO_VISTEX", "SETTLEMENT_PARTNER", "PRIMED_CUST_NM", "PRIMED_CUST_CNTRY", "PRIMED_CUST_ID", "IS_PRIMED_CUST", "PROGRAM_PAYMENT", "PNL_SPLIT", "PnL_Split_for_KITS", "PORTFOLIO", "PRD_NM_COMBINED", "PRODUCT_FILTER", "PRODUCT_TITLE", "PROG_VOLTIER_NM", "PROGRAM_GEO", "PROGRAM_GEO_COMBINED", "PGM_PAYMENT", "PROGRAM_TYPE", "PROGRAM_TYPE_VOL_TIER", "QLTR_PROJECT", "QLTR_TERMS", "QUOTE_LN_ID", "RATE", "RATE_BASED_ON", "REBATE_BILLING_END", "REBATE_BILLING_START", "REBATE_DEAL_ID", "REQ_BY", "REQ_DT", "RETAIL_CYCLE", "SA_COST_TEST_RESULTS", "SERVER_DEAL_TYPE", "START_DT", "STRT_CAP", "STRT_VOL", "TENDER_PRICE", "TIER_NBR", "TOTAL_DOLLAR_AMOUNT", "TRGT_RGN", "TRKR_END_DT", "TRKR_NBR", "TRKR_START_DT", "VOLUME", "YCS_OVERLAP_OVERRIDE"];
