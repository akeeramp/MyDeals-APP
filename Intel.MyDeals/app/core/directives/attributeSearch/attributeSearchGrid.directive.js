        ...
        controller: ['$scope', '$http', function ($scope, $http) {
            ...
            $scope.gridOptions = {
                ...
                filterMenuInit: function (e) {
                    var hideOperatorForAtrbs = ["OBJ_SET_TYPE_CD", "OBJ_SET_TYPE_CD", "Customer.CUST_NM", "WF_STG_CD", "MRKT_SEG", "REBATE_TYPE", "PROGRAM_PAYMENT", "PAYOUT_BASED_ON", "SERVER_DEAL_TYPE"];
