...
(function () {
    ...
    angular
        ...
        .constant('contractManagerConstants', {
            ...
            "C2AIdDesc": "Either C2A id is entered or an attachment to deal request is uploaded below.  If 'Acceptance Not Required in C2A' is selected, please attach documentation below.",
