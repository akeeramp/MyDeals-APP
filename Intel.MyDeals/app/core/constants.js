...
(function () {
    ...
    angular
        ...
        .constant('contractManagerConstants', {
            ...
            "C2AIdDesc": "Please enter the C2A Contract # associated with the contract. Please note, values longer than 18 characters will be truncated in Vistex.  Characters (like semicolons) not supported by Vistex will also be removed.",
