...
export const routesAdmin: Routes = [
    ...
    { path: 'pctMctFailureReport', component: PctMctExceptionReportComponent, data: { title: 'Admin', BaseHref: 'Admin' }, resolve: { security: SecurityResolver }, canActivate: [authGuard] }
];