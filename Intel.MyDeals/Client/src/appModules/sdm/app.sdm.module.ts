...
import { SdmMasterDataModalComponent } from '../../app/sdm/sdmMasterDataModal/sdmMasterDataModal.component';
//*********************dashboard util components *********************
import { SDMUtilComponents } from './sdm-util.module';
import { broadCastService } from '../../app/core/dealPopup/broadcast.service';
//*********************Angular single boot files *********************
//spreadsheet component
import { HotTableModule } from '@handsontable/angular';
import { registerAllModules } from 'handsontable/registry';
import { routesSDM } from './app.route-sdm.component';
...
@NgModule({
    imports: [
        ...
        ScrollingModule,
        MenuModule,
        RouterModule.forRoot(routesSDM, { useHash: true })
    ],
    providers: [
        {
    ...
    declarations: [
        AppRootComponent,
        SDMComponent,
        sdmBulkUploadComponent,
        SDMUtilComponents,
        SdmMasterDataModalComponent
    ],
    entryComponents:[
        AppRootComponent,
        SDMComponent,
