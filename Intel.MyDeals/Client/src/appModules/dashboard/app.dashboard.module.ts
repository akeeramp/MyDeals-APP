...
import { dashboardComponents } from '../../app/modules/dashboard.module';
//*********************dashboard util components *********************
import { DashboardUtilComponents } from './dashboard-util.module';
import { broadCastService } from '../../app/core/dealPopup/broadcast.service';
//*********************Angular single boot files *********************
import { routesDashboard } from './app.route-dashboard.component';
...
@NgModule({
    imports: [
        ...
        DragDropModule,
        ScrollingModule,
        RouterModule.forRoot(routesDashboard, { useHash: true })
    ],
    providers: [
        {
