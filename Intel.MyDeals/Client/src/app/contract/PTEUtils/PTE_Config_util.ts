export class PTE_Config_Util {
    ...
    static tenderDashboardDropColumns = ["CUST_MBR_SID", "PAYOUT_BASED_ON", "PERIOD_PROFILE", "MRKT_SEG", "AR_SETTLEMENT_LVL", "PROGRAM_PAYMENT", "WF_STG_CD", "SERVER_DEAL_TYPE", "COST_TEST_RESULT", "MEETCOMP_TEST_RESULT","PASSED_VALIDATION"];
    ...
    static tenderDashboardNumericColumns = ["ECAP_PRICE", "CAP", "REBATE_OA_MAX_VOL", "REBATE_OA_MAX_AMT", "VOLUME", "CREDIT_VOLUME", "DEBIT_VOLUME", "CREDIT_AMT", "DEBIT_AMT", "TOTAL_DOLLAR_AMOUNT", "CONSUMPTION_LOOKBACK_PERIOD"];
