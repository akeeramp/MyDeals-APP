...
export class globalSearchResultsService { 
    ...
    public getObjectType(search: string, take: number, opType: string, inactCust: boolean = false){
       return this.httpClient.get(this.apiBaseUrl + `${opType}/${take}/${inactCust}/${search}`);
    }
    ...
    public getInActContractIDDetails(id, opType) {
        this.apiUrl = "GotoInActDeal/";
        return this.httpClient.get("api/Search/" + this.apiUrl + id);
    }
}