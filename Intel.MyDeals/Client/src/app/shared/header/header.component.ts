...
export const HeaderController = {
  ...
  controller: class HeaderComponent {
    ...
    getUserDetails() {
      ...
      //get the API Call
      this.headerSvc.getAntiForgeryTokenToken().then(function(){
        console.log('***************************** Header Component second ************************');
       this.headerSvc
        .getUserDetails()
        .subscrible(res => {
          this.usrName = res.usrName;
          this.usrWwid =  res.usrWwid;
          this.usrRole = res.usrRole;
          this.usrRoleId = res.usrRoleId;
          this.usrEmail = res.usrEmail
          ...
          this.isEditableGrid = res.isEditableGrid? res.isEditableGrid:true;
          this.appVer = res.appVer? res.appVer:"1.2.0.24863";
          this.isCustomerAdmin = res.isCustomerAdmin ? res.isCustomerAdmin:true;
