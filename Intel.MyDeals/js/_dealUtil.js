...
dealUtil.init = function () {
    ...
    dealUtil.columns = [
        ...
        { field: "TOTAL_DOLLAR_AMOUNT", title: "Total Dollar Amount", group: "Program, Vol Tier", encoded: true, locked: false, sortable: true, filterable: true, hidden: false, width: 200, format: "{0:c}", editable: true },
        { field: "PROGRAM_TYPE", title: "Program Type", group: "Program, Vol Tier", encoded: true, locked: false, sortable: true, filterable: false, hidden: false, width: 100, editable: true, editor: dealUtil.lookupEditor },
        { field: "DEAL_DESC", title: "Deal Description", group: "Program, Vol Tier", encoded: true, locked: false, sortable: true, filterable: false, hidden: false, width: 100, editable: true },
